...
local  meter_colle_notify=function(mac,child_id,code)

	print("meter_colle_notify" .. " mac=" .. aux_core.StrToHexStr(mac,":"))
...
local meter_colle_zigbee_recive =function(mac,child_id,rssi,data_type,data)
	
	print("meter_colle_zigbee_recive" .. " mac=" .. aux_core.StrToHexStr(mac,":"))
...
local meter_colle_send_prcess_prcess=function(mac,code,rssi,data_type,data)
	print("meter_colle_send_prcess_prcess code =" .. code )
end

local meter_colle_coap_recive=function(mac,child_id,fd,token,pdu)

	print("meter_colle_coap_recive")
	...
	local zcl_write={}
		...
		zbdev.send(mac,0x0900,pack,pack:size(),meter_colle_send_prcess_prcess,nil)
...
zigbee_obj_register_devmodle("dev_meter_colle",dev_meter_colle,meter_colle_coap_recive,meter_colle_zigbee_recive,meter_colle_notify,0)
